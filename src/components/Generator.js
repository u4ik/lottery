                ...
                return (
                    ...
                    <div key = { index } > {
                        ...
                        <div> {firstNum == winning.winning_numbers.slice(0, 2) ?
                            <ul >
                            <li style = { firstNumHisWinStyle } > The number : { firstNum },
                            has won at the first position on: { winning.draw_date.slice(0, 10) } </li></ul >: null
                        } </div>: null
                    } {
                        selectSecondNum ?
                            <div > {
                                ...
                                <ul >
                                <li style = { firstNumHisWinStyle } > The number : { secondNum },
                        ...
                        selectThirdNum ?
                            <div> {
                                ...
                                <ul >
                                <li style = { firstNumHisWinStyle } > The number : { thirdNum },
                        ...
                        selectFourthNum ?
                            <div> {
                                ...
                                <ul >
                                <li style = { firstNumHisWinStyle } > The number : { fourthNum },
                        ...
                        selectFifthNum ?
                            <div> {
                                ...
                                <ul>
                                <li style = { firstNumHisWinStyle } > The number : { fifthNum },
                        ...
                        selectMBallNum ?
                            <div > {
                                ...
                                <ul>
                                <li style = { firstNumHisWinStyle } > The number : { mBallNum },
